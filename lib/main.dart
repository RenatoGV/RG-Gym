...
import 'package:rg_gym/screens/tabs/exercises/exercise_info.dart';
import 'package:rg_gym/screens/tabs/exercises/exercises.dart';
import 'package:rg_gym/screens/tabs/exercises/search_exercise.dart';
import 'package:rg_gym/screens/tabs/routines/execution.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        AppRouter.routineDetail: (_) => const RoutineDetail(),
        AppRouter.workoutDetail: (_) => const WorkoutDetail(),
        AppRouter.exerciseDetail: (_) => const ExerciseDetail(),
        AppRouter.exercises: (_) => const Exercises(),
        AppRouter.searchExercise: (_) => const SearchExercise(),
        AppRouter.exerciseInfo: (context) {
